...
> 配置先: ドキュメント `01_教材 > LESSON3_ルーティングとサービス > Exercise14`
...
ここが今日の山場です。時間をかけて構いません。NAT では次の 4 つの用語を正確に区別する必要があります。組み合わせると
...
> 添えて先輩やリーダーへエスカレーションするのが現場のルールです。DMZ を
...
本日のラボ課題「[Exercise14] ラボ: 静的 NAT・動的 NAT・PAT の構成と変換テーブルの観察」に
