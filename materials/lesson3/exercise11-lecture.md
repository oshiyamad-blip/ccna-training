...
> 教材を見ずに、まず自力で思い出してください（分散学習: Exercise 2「TCP / UDP・
> スイッチング動作・物理層」 / Exercise 9「STP と EtherChannel」 / Exercise 5「ルーティングの
> 基礎と静的ルート」 の範囲から出題）。

**W1.** （Exercise 2）TCP のスリーウェイハンドシェイクの 3 つのパケットを順に答えよ。
...
**W3.** （Exercise 5）ルータが経路を選ぶ際の 3 段階ロジックを順に答えよ。また、
