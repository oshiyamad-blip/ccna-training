# Exercise 11 ラボ手順書: OSPFv2 シングルエリアの構成と経路制御

> 配置先: ドキュメント `02_ラボ手順書 > LESSON3 > Exercise11`
...
![Exercise 11 トポロジ図](../images/exercise11-topology.png)
...
2. ファイルを保存する: `File > Save As` で `exercise11_氏名.pkt` として保存する
...
1. `exercise11_氏名.pkt` を Backlog のラボ課題に**添付**する
