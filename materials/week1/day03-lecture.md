...
（Week0 P2 で学んだ 2 進数⇔10 進数の変換と同じ考え方です）。先頭ビットは `0` で固定、
...
グローバルアドレスに変換する必要があります。NAT/PAT の設定詳細は Day 14 で
...
![VLSM設計: 大きいブロックから連続して割り当てる](../images/day03-vlsm-block-allocation.png)
