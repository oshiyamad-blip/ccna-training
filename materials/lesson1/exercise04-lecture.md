# Exercise 4 講義: IPv6 アドレッシング

> 配置先: ドキュメント `01_教材 > LESSON1_ネットワーク基礎 > Exercise04`
...
> OSI / TCP-IP モデル」 / Exercise 3「IPv4 アドレッシングとサブネット化」 の範囲から出題）。
...
プレフィックス長（ネットワーク部のビット数）は、Exercise 3 で学んだ IPv4 の CIDR 表記と
...
![EUI-64によるインターフェースID生成の流れ](../images/exercise04-eui64-conversion.png)
...
> **先に 2 つの言葉を紹介します**（詳しくは Exercise 15 で学びます。ここでは一行ずつで OK）。
>
...
この Exercise のラボ課題「[Exercise04] ラボ: IPv6 アドレッシング — 静的設定と SLAAC の
