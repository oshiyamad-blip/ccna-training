...
![Exercise 1 トポロジ図](../images/exercise01-topology.png)
...
> ポートを確認中です。焦らず待ちましょう（詳しい動作は Exercise 9 の STP で学びます）。
...
3. ファイルを保存: `File > Save As` → `exercise01_氏名.pkt`
...
## 手順 4: シミュレーションモードでカプセル化を観察（60 分・この Exercise のメイン）
...
1. `exercise01_氏名.pkt` を Backlog のラボ課題に**添付**する
