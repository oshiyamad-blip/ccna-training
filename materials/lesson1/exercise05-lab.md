# Exercise 5 ラボ手順書: MAC アドレステーブルと ARP の観察、デュプレックス不一致の障害切り分け

> 配置先: ドキュメント `02_ラボ手順書 > LESSON1 > Exercise05`
...
![Exercise 5 トポロジ図](../images/exercise05-topology.png)
...
2. ファイルを保存: `File > Save As` → `exercise05_氏名.pkt`
...
1. `exercise05_氏名.pkt` を Backlog のラボ課題に**添付**する
