...
> 教材を見ずに、まず自力で思い出してください（分散学習: Exercise 1「ネットワークの全体像と OSI / TCP-IP モデル」 の範囲から出題）。

**W1.** OSI 参照モデルの第 3 層（ネットワーク層）と第 2 層（データリンク層）が、それぞれ
宛先を判断するために使うアドレスの名称を答えよ。

<details><summary>解答</summary>

W1. L3 = IP アドレス／L2 = MAC アドレス
...
この Exercise のラボ課題「[Exercise02] ラボ: MAC アドレステーブルと ARP の観察、
