# Exercise 2 講義: Cisco IOS の基本操作とデバイス初期設定

> 配置先: ドキュメント `01_教材 > LESSON1_ネットワーク基礎 > Exercise02`
...
![IOS コマンドモードの状態遷移](../images/exercise02-ios-command-modes.png)
...
> 知識**（次の Exercise 3 で詳しく学びます）を使うため、初見で難しく感じたら、いったん
> コマンドを写して動かすだけで OK です。**Exercise 3 を終えたあとにこの章へ戻って読み直す**と、
...
この Exercise のラボ課題「[Exercise02] ラボ: IOS の基本操作とデバイス初期設定」に進み、実機
