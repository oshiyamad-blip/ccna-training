...
> 知識**（明日の Exercise 3 で詳しく学びます）を使うため、初見で難しく感じたら、いったん
...
― スイッチのポートを論理的にグループ分けする仕組みで、詳しくは Exercise 6 で学びます
...
（LESSON0 P5 で学んだ、自分のネットワークの外へ出るときに通る出口です）を明示的に
教えてやる必要があります。
...
本日のラボ課題「[Exercise02] ラボ: IOS の基本操作とデバイス初期設定」に進み、実機
