...
> 配置先: ドキュメント `01_教材 > LESSON1_ネットワーク基礎 > Exercise1`
...
ウェルノウンポートの暗記は Exercise 2 で改めて取り組みます。
...
- L2 ヘッダの**送信元・宛先 MAC アドレスは、ともにルータを通過するたびに書き換わる**が、
  ...
  Translation、IP アドレスを変換する技術〉を除く。詳しくは Exercise 13 で学びます）
...
この Exercise のラボ課題「[Exercise1] ラボ: PT入門 — 最小構成の作成とカプセル化の観察」
