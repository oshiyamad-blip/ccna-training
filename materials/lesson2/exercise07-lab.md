...
5. ファイルを保存: `File > Save As` → `exercise07_氏名.pkt`
...
1. ファイル名を `exercise07_氏名.pkt` にして保存する（例: `exercise07_山田太郎.pkt`）
2. Backlog のラボ課題に `exercise07_氏名.pkt` を**添付**する
