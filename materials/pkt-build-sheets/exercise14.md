...
- **対象ラボ**: `materials/lesson3/exercise14-lab.md`（静的 NAT・動的 NAT・PAT（NAT Overload）の
...
> いずれも本シートおよび `exercise14-lab.md` の IP アドレス表・手順1・手順2と完全一致している。
...
一切含めない**——これらが exercise14 の本題であり、受講者が入力する部分として空のまま
残す。
