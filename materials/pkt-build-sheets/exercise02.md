...
- **対象ラボ**: `materials/lesson1/exercise02-lab.md`（MAC アドレステーブルと ARP の観察、デュプレックス不一致の障害切り分け）
...
> 参考画像: `materials/images/exercise02-topology.svg` は現状リポジトリに存在しない
  （ラボ手順書が参照する `exercise02-topology.png` も未配置）。本シートは
  `exercise02-lab.md` の「完成トポロジ」節のテキスト記述と IP アドレス割り当て表を
...
- [ ] `exercise02_start.pkt` として保存し、再度開いて上記の状態が保たれていることを確認
