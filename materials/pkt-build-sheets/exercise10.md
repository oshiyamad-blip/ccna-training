# exercise10 .pktビルドシート

- **対象ラボ**: `materials/lesson2/exercise10-lab.md`（WLC と Lightweight AP による WLAN 構築、CDP/LLDP による隣接機器確認）
...
- [ ] `exercise10_start.pkt` として保存し、再度開いて上記の状態
