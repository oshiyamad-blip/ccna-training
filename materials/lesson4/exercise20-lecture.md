...
LESSON1〜3 で受けた LESSON まとめテスト（Exercise5・Exercise10・Exercise15）の誤答を
...
>
> - **有効ホスト数** = 2^(ホストビット数) − 2
> - **ブロックサイズ（増分）** = 256 − （マスクが掛かるオクテット〈Exercise 3 で
...
> つなぐ話です。配点最大のドメイン 3（25%）を含む、Exercise 11〜15 の総復習にあたります。
