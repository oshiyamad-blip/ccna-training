# Exercise 16 ラボ手順書: デバイス堅牢化 — SSH 管理とログイン保護の実装

> 配置先: ドキュメント `02_ラボ手順書 > LESSON4 > Exercise16`
...
![Exercise 16 トポロジ図](../images/exercise16-topology.png)
...
5. リンクがすべて緑になったことを確認し、`exercise16_氏名.pkt` として保存する
...
## 手順 13: 総合検証（15 分・この Exercise のメイン）
...
1. `exercise16_氏名.pkt` を Backlog のラボ課題に**添付**する
