...
export const PRE_PHASE_ISSUES = [
  { day: 1, type: '講義', summary: '[P1] 講義: コンピュータのきほん（ハードウェア・OS・ファイル）',
  ...
  { day: 2, type: '講義', summary: '[P2] 講義: 数のきほん（2進数・16進数・単位）',
  ...
  { day: 3, type: '講義', summary: '[P3] 講義: インターネットのきほん（Webの仕組み・データの旅）',
  ...
  { day: 4, type: '講義', summary: '[P4] 講義: 仕事のITきほん（Backlog・Markdown・セキュリティ）',
  ...
  { day: 5, type: '講義', summary: '[P5] 講義: ネットワークにさわってみる（ipconfig・Packet Tracer準備）',
